...
A named `function` is a function declaration written with the function keyword and provided with a distinct name. Named function declarations load into the execution context before any code runs. This is known as hoisting, meaning you can use the function before you declare it.
